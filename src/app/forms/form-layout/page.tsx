  ...
  return (
    <>
      <div className="w-full bg-slate-100">
        <div className="flex w-full flex-col items-center justify-center gap-9 p-8">
          <div className="w-1/2 rounded-sm border border-stroke bg-white shadow-default">
              ...
              <div className="flex flex-col">
                ...
                <div className="ml-5 flex w-full flex-row items-center gap-3">
                  ...
                  >
                    X{" "}
                    {price
                      ? `R$ ${(parseFloat(price) / 100).toLocaleString(
                          "pt-BR",
                          {
            ...
            <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
              <div className="border-b border-stroke px-6.5 py-4 dark:border-strokedark">
                <div className="flex flex-row items-center gap-4">
                  <span className="rounded-full border-2 border-blue-600 px-3 py-1 font-bold text-blue-600">
                    2
                  </span>
                  <Contact className="text-lg text-blue-600" />
                  <h3 className="text-lg font-bold text-blue-600 ">ENDEREÇO</h3>
                </div>
              </div>
              <form action="#">
                <div className="p-6.5">
